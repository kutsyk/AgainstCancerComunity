...
var hotspots_config = {
    'hotspots': [{
        'hover': '<u><b>Hotspot "A"</b></u><br>Add unlimited number of spots<br>anywhere on the diagram and<br>customize its colors and size and<br>link it to any webpage.',
        'pos_X': 84,
        'pos_Y': 137,
        'diameter': 16,
        'upColor': '#FF0000',
...
var organs_config = {
    'organ_1': {
        'hover': '<b><u>APPENDIX</u></b><br><span style="color: #808080;">Set any part as:<br><b>"active"</b> > clickable or<br><b>"inactive"</b> > not clickable.</span>',
        'enable': !0,
        'url': '/level/appendix',
        'target': 'same_window',
        'upColor': 'red',
    ...
    'organ_2': {
        'hover': '<b><u>BLADDER</u></b><br>Write any text and load images<br><img src="assets/images/hover.png">',
        'enable': !0,
        'url': '/level',
        'target': 'same_window',
        'upColor': '#FF0000',
    ...
    'organ_3': {
        'hover': '<b><u>DIAPHRAGM</u></b><br>Write any text and load images<br><img src="assets/images/hover.png">',
        'enable': !0,
        'url': '/level',
        'target': 'same_window',
        'upColor': '#FF0000',
    ...
    'organ_4': {
        'hover': '<b><u>GALLBLADDER</u></b><br><span style="color: #808080;">Set any part as:<br><b>"active"</b> > clickable or<br><b>"inactive"</b> > not clickable.</span>',
        'enable': !0,
        'url': '/level/gallbladder',
        'target': 'same_window',
        'upColor': '#FF0000',
        'upOpacity': '0',
        'outlineUpColor': '#FF0000',
    ...
    'organ_5': {
        'hover': '<b><u>HEART</u></b><br>Write any text and load images<br><img src="assets/images/hover.png">',
        'enable': !0,
        'url': '/level/heart',
        'target': 'same_window',
        'upColor': '#FF0000',
    ...
    'organ_6': {
        'hover': '<b><u>KIDNEYS</u></b><br>Write any text and load images<br><img src="assets/images/hover.png">',
        'enable': !0,
        'url': '/level/kidneys',
        'target': 'same_window',
        'upColor': '#FF0000',
    ...
    'organ_7': {
        'hover': '<b><u>LARGE INTESTINE</u></b><br><span style="color: #808080;">Set any part as:<br><b>"active"</b> > clickable or<br><b>"inactive"</b> > not clickable.</span>',
        'enable': !0,
        'url': '/level/intestine',
        'target': 'same_window',
        'upColor': '#FF0000',
    ...
    'organ_10': {
        'hover': '<b><u>LUNGS</u></b><br><span style="color: #ff1a75;">*Link each part to any webpage*</span>',
        'enable': !0,
        'url': '/level/lungs',
        'target': 'same_window',
        'upColor': '#FF0000',
    ...
    'organ_11': {
        'hover': '<b><u>MAJOR BLOOD VESSELS</u></b><br>Write any text and load images<br><img src="assets/images/hover.png">',
        'enable': !0,
        'url': '/level/vessels',
        'target': 'same_window',
        'upColor': '#FF0000',
    ...
    'organ_12': {
        'hover': '<b><u>PANCREAS</u></b><br>Write any text and load images<br><img src="assets/images/hover.png">',
        'enable': !0,
        'url': '/level/pancreas',
        'target': 'same_window',
        'upColor': '#FF0000',
    ...
    'organ_17': {
        'hover': '<b><u>TRACHEA</u></b><br>Write any text and load images<br><img src="assets/images/hover.png">',
        'enable': !0,
        'url': '/level/trachea',
        'target': 'same_window',
        'upColor': '#FF0000',
    ...
    'organ_18': {
        'hover': '<b><u>URETERS</u></b><br>Write any text and load images<br><img src="assets/images/hover.png">',
        'enable': !0,
        'url': '/level/ureters',
        'target': 'same_window',
        'upColor': '#FF0000',
